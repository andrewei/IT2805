/*
FILE NAME: EventLoader.js
WRITTEN BY: Andreas
WHEN: November 2015
PURPOSE: 	This Javascript file creates elements to put in content-container
			This javascript has two main functions, which is selected(int) and show(int).
			Selected(int) determines which event is showed in the bottom of the screen, while show(int) determines if there i a horizontal list or a drop-down menu
*/
